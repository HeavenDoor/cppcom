...
CComCallerDlg::CComCallerDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CComCallerDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CComCallerDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CComCallerDlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
#include "..\CppCom\CppCom_i.h"
#include "..\CppCom\CppCom_i.c"
void CComCallerDlg::OnBnClickedButton1()
{
	CoInitialize(NULL);
	IComInterface *test =NULL;
	CoCreateInstance(CLSID_ComInterface,NULL,1,IID_IComInterface,(void**)&test);
