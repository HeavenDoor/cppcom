========================================================================
    ACTIVE TEMPLATE LIBRARY : CppCom Project Overview
========================================================================

AppWizard has created this CppCom project for you to use as the starting point for
...
CppCom.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (CppCom.h)
        GUID definitions                                (CppCom_i.c)
        A type library                                  (CppCom.tlb)
        Marshaling code                                 (CppCom_p.c and dlldata.c)

CppCom.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in CppCom.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named CppCom.pch and a precompiled types file named StdAfx.obj.
...
CppComps.vcxproj
	...
	dlldata.c, CppCom_i.c and CppCom_p.c which are required
	to build the proxy/stub DLL.

CppComps.vcxproj.filters
